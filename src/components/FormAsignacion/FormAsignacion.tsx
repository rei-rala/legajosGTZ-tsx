...
const FormAsignacion: React.FC = () => {
  ...
  return (
    <section className="asignacionContainer">
          ...
          <select name="legajo" id="legajoSelect" required>
            ...
            <optgroup label="Empresa">
              {!LegajosFB ? (
                ...
                LegajosFB.sort((x: ILegajo, y: ILegajo) =>
                  x.razonSocial.localeCompare(y.razonSocial)
                ).map((l: ILegajo) => {
                  return (
                    <OptionAsignacion
                      key={l.id}
          ...
          <select name="analista" id="analistaSelect" required>
            ...
            <optgroup label="Disponibles">
              {!AnalistasFB ? (
                ...
                AnalistasFB.sort((x: IAnalista, y: IAnalista) =>
